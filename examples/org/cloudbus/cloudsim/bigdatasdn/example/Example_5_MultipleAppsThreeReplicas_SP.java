...
/**
 * This is an example of running multiple MapReduce applications (three replicas) in a traditional network cloud data center (without SDN capabilities)
 * @author Khaled Alwasel
 * @contact kalwasel@gmail.com
 * @since BigDataSDNSim 1.0
 */

public class Example_5_MultipleAppsThreeReplicas_SP {
	...
	public static void main(String args[]) throws Exception {						
		Example_5_MultipleAppsThreeReplicas_SP bigDataSDN = new Example_5_MultipleAppsThreeReplicas_SP(); 		
		bigDataSDN.run();
	}
