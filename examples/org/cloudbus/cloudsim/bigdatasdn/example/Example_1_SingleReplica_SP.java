...
/**
 * This is an example of running a single replica MapReduce application in a traditional network cloud data center (without SDN capabilities)
 * @author Khaled Alwasel
 * @contact kalwasel@gmail.com
 * @since BigDataSDNSim 1.0
 */

public class Example_1_SingleReplica_SP {
	...
	public static void main(String args[]) throws Exception {						
		Example_1_SingleReplica_SP bigDataSDN = new Example_1_SingleReplica_SP(); 		
		bigDataSDN.run();
	}
