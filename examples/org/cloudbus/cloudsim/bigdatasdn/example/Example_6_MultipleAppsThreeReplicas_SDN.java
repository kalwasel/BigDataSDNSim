...
import org.cloudbus.cloudsim.bigdatasdn.bdms.polocies.SDNRoutingLoadBalancing;
...
/**
 * This is an example of running a multiple MapReduce applications (three replicas) using an SDN load balancing in a cloud data center 
 * @author Khaled Alwasel
 * @contact kalwasel@gmail.com
 * @since BigDataSDNSim 1.0
 */

public class Example_6_MultipleAppsThreeReplicas_SDN {

	protected static String physicalTopologyFile 	= "inputFiles/Datacenter_Configuration.json";
	protected static String appFileName = "inputFiles/MultipleApps_ThreeReplica_Workload.csv"; 		
	...
	public static void main(String args[]) throws Exception {						
		Example_6_MultipleAppsThreeReplicas_SDN bigDataSDN = new Example_6_MultipleAppsThreeReplicas_SDN(); 		
		bigDataSDN.run();
	}
	...
	public void run() throws IOException {
		...
		try {
			...
			SDNRoutingPolicy sdnRouting = new SDNRoutingLoadBalancing(); // with SDN 
