...
/**
 * This is an example of running a three replicas MapReduce application in a traditional network cloud data center (without SDN capabilities)
 * @author Khaled Alwasel
 * @contact kalwasel@gmail.com
 * @since BigDataSDNSim 1.0
 */

public class Example_3_ThreeReplicas_SP {
	...
	public static void main(String args[]) throws Exception {						
		Example_3_ThreeReplicas_SP bigDataSDN = new Example_3_ThreeReplicas_SP(); 		
		bigDataSDN.run();
	}
