...
/**
 * This is an example of running a single replica MapReduce application using an SDN load balancing in a cloud data center 
 * @author Khaled Alwasel
 * @contact kalwasel@gmail.com
 * @since BigDataSDNSim 1.0
 */

public class Example_2_SingleReplicas_SDN {

	protected static String physicalTopologyFile 	= "inputFiles/Datacenter_Configuration.json";
	protected static String appFileName = "inputFiles/SingleReplica_Workload.csv"; 		
	...
	public static void main(String args[]) throws Exception {						
		Example_2_SingleReplicas_SDN bigDataSDN = new Example_2_SingleReplicas_SDN(); 		
		bigDataSDN.run();
	}
