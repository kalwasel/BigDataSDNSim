 ...
 * using an SDN load balancing in a cloud data center 
 * 
...
public class Example_8_Priority_MultipleAppsThreeReplicas_SDN {
	...
	public static void main(String args[]) throws Exception {						
		Example_8_Priority_MultipleAppsThreeReplicas_SDN bigDataSDN = new Example_8_Priority_MultipleAppsThreeReplicas_SDN(); 		
		bigDataSDN.run();
	}
