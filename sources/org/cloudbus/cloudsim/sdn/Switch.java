...
public class Switch extends SimEntity implements NetworkNIC{
	...
	public Switch(String name, long bw, long iops, int upports, int downports) {
		...
		if (upports>0) this.upports = new NetworkNIC[upports];
		this.downports = new NetworkNIC[downports];
	...
	@Override
	public void addVMRoute(int src, int dest, int flowId, NetworkNIC to){
