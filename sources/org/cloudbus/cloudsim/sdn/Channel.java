...
public class Channel {
	...
	private boolean bwIsReserved = false;	
	private Map<Double, Double> bwChangesLogMap = new TreeMap<Double, Double>();

	public Channel(int chId, int srcId, int dstId, List<NetworkNIC> nodes, List<Link> links, double bandwidth) {
		this.chId = chId;
		this.srcId = srcId;
		this.dstId = dstId;
		this.nodes = nodes;
	...
	public boolean getBwIsReserved() {
		return bwIsReserved;
	}

	public void setBwIsReserved(boolean bwIsreserved) {
		this.bwIsReserved = bwIsreserved;
	}
