...
////		for(NetworkNIC node:this.topology.getAllNodes()) {
////			node.printVMRoute();
////		}
////		return true;
////	}
//	
//	private boolean buildRoutingTables(NetworkNIC node, int srcVm, int dstVm, int flowId, NetworkNIC prevNode) {
...
//			for(Link l:links) {
//				NetworkNIC nextHop= l.getHighOrder();
