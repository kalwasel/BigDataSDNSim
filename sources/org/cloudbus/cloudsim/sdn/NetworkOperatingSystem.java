...
import org.cloudbus.cloudsim.bigdatasdn.bdms.Topology;
...
public abstract class NetworkOperatingSystem extends SimEntity {
	...
	protected void sendInternalEvent() {
		CloudSim.cancelAll(getId(), new PredicateType(BigDataSDNSimTags.SDN_INTERNAL_EVENT));
		if(channelTable.size() != 0) {
			...
			send(this.getId(), delay, BigDataSDNSimTags.SDN_INTERNAL_EVENT);
		}		
	}
